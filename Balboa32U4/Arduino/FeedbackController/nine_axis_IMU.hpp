#ifndef NINE_AXIS_IMU_HPP
#define NINE_AXIS_IMU_HPP
...
void updateIMU(void)
{
    ...
    ax = imu.a.x * 0.244 * 0.001;  // FS_XL 8 g => 4,096 LSB/g [0.244 mg/LSB]
    ay = imu.a.y * 0.244 * 0.001;
    az = imu.a.z * 0.244 * 0.001;

    // 角速度値を分解能で割って角速度(degrees per sec)に変換する
    gx = (imu.g.x-imu.cg.x) * 17.5 * 0.001;  // FS_G 500 dps => 57.1 LSB/dps [17.50 mdps/LSB]
    gy = (imu.g.y-imu.cg.y) * 17.5 * 0.001;
    gz = (imu.g.z-imu.cg.z) * 17.5 * 0.001;
